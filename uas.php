...
if (isset($_POST['submit'])) {
  ...
  $infaq = $_POST ['infaq'];
    ...
    class Hasil{
      ...
      public function hasilnya($no, $name, $unit, $tanggal, $jabatan, $gaji, $lamaKerja, $status, $bonus, $bpjs, $pinjaman, $cicilan, $infaq, $gajiBersih){
        echo
        "<center>
        <table border=0>
        <tr>
        ...
        <tr>
            <td>Gaji Bersih</td>
            <td>: Rp. $gajiBersih <br></td> 
        </tr>";
      }
    }
    
    $cetak = new Hasil();
    echo $cetak->hasilnya($no, $name, $unit, $tanggal, $jabatan, $gaji, $lamaKerja, $status, $bonus, $bpjs, $pinjaman, $cicilan, $infaq, $gajiBersih);
}
?>